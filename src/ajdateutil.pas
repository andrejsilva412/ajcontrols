...
uses SysUtils, AJStrUtils, AJdconst{, DBConsts }{$IFDEF WIN32}, Windows{$ENDIF};
...
//      doMDY, doDMY: Result := '!99/99/9999;1;';
  //    doYMD: Result := '!9999/99/99;1;';
      doMDY, doDMY: Result := '99/99/9999;';
      doYMD: Result := '9999/99/99;';
    ...
    case GetDateOrder(ShortDateFormat) of
      ...
      doMDY, doDMY: Result := '99/99/99;';
      doYMD: Result := '99/99/99;';
    end;
  end;

...
uses
  {$ifdef windows} Windows, {$endif} Classes, Controls, FileUtil, Forms,
  IniFiles, Grids, Graphics;
...
{$ifdef windows}
procedure GlassForm(frm: TForm; tmpMargins: TMargins; cBlurColorKey: TColor);
...
uses
  SysUtils, LCLStrConsts, AJPlacement;
